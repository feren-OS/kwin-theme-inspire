...
#include "inspireconfigwidget.h"
#include "inspireexceptionlist.h"
...
namespace Inspire
{
    ...
    ConfigWidget::ConfigWidget( QWidget* parent, const QVariantList &args ):
        ...
        m_configuration( KSharedConfig::openConfig( QStringLiteral( "inspirerc" ) ) ),
        m_changed( false )
    {
    ...
    void ConfigWidget::save()
    {
        ...
        // needed for inspire style to reload shadows
        {
            QDBusMessage message( QDBusMessage::createSignal("/InspireDecoration",  "org.kde.Inspire.Style", "reparseConfiguration") );
            QDBusConnection::sessionBus().send(message);
        }
